...
@Component({
  selector: 'app-etat-liste-paiements',
  templateUrl: './etat-liste-paiements.component.html',
  styleUrls: ['./etat-liste-paiements.component.scss'],
})
export class EtatListePaiementsComponent {
